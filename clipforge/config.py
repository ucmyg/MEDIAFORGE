...
class StyleCfg(BaseModel):
    ...
    font_size: int = 96  # in 1080x1920 pixel space (libass Fontsize; ~0.47*size cap height for Montserrat)
    uppercase: bool = True
...
class Settings(BaseSettings):
    ...
    tighten: bool = False
    smart: bool = True  # face-tracked 9:16 crop keeps the speaker in frame; --no-smart for a fixed centre crop
    punch: bool = False
